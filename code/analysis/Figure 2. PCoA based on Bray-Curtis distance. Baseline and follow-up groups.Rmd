---
title: An R Markdown document converted from "./Figure 2. PCoA based on Bray-Curtis
  distance. Baseline and follow-up groups.ipynb"
...
explained_variance_proportions <- pcoa_res$values$Relative_eig
explained_variance_percents <- explained_variance_proportions * 100
```
...
# add titles
      labs(x = paste0("PCoA 1 (", sprintf('%.2f', explained_variance_percents[1]), "%)"), 
           y = paste0("PCoA 2 (", sprintf('%.2f', explained_variance_percents[2]), "%)"), 
