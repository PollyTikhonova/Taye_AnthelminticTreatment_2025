---
title: An R Markdown document converted from "./Figure 3. Microbial relative abudance
  barplots.ipynb"
...
p <- plot_nested_bar(ps_obj = top_nested$ps_obj,
                top_level = "Phylum",
                nested_level = "Genus", 
                palette = c(Bacteroidota = "#763501", 
                            Bacillota = "#3e2248",
#                             Cyanobacteriota = "#835269",
                            Cyanobacteriota = "#329b96",
                            Pseudomonadota = "#b9a04f", 
                            Elusimicrobiota = '#f1c200', 
                            Spirochaetota =  '#006531' 
                           )) +
      theme_minimal() +
