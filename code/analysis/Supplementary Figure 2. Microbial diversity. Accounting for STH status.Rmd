---
title: An R Markdown document converted from "./Supplementary Figure 2. Microbial
  diversity. Accounting for STH status.ipynb"
...
k = 0.3
ggsave(file=file.path('../../results/figures', 'supplementary_figure2', 'baseline_followup_STH.alpha_diversity.svg'), plot=p, 
